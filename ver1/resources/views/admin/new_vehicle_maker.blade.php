    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="hpanel">
                ...
                <div class="panel-body">
                <form method="post" action="/admin/settings/add-new-vehicle-maker" enctype="application/x-www-form-urlencoded" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-12 control-label pull-left" style="text-align: left !important">Enter Vehicle Makers</label>
                    </div>
                    <div class="form-group">
