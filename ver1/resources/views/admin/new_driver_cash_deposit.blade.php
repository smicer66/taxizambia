    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="hpanel">
                ...
                <div class="panel-body">
                <form method="post" action="/admin/financials/fund-driver-account" enctype="application/x-www-form-urlencoded" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-12 control-label pull-left" style="text-align: left !important">Enter Vehicle Types</label>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
							<select name="driver" class="form-control">
                                ...
                                @foreach($list as $driver)
                                    <option value="{{$driver->id}}|||{{$driver->name}}|||{{$driver->vehicleId}}">{{$driver->name}} - {{$driver->vehicle_plate_number}}</option>
                                @endforeach
                            </select></div>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-8">
                        ...
                        <button class="btn btn-primary" name="submit" value="Save" type="submit">Credit Driver</button>
                    </div>
                </div>
                </form>
                </div>
