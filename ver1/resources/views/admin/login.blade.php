...
<div class="login-container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="text-center m-b-md">
                <h3>Tweende</h3>
                <small>Please login with valid login details!</small>
            </div>
            <div class="hpanel">
                <div class="panel-body">
                        <form action="/auth/login" method="post" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="example@gmail.com" title="Please enter you username" required="" value="0974365365" name="mobileNumber" id="username" class="form-control">
                                <span class="help-block small">Only Administrators are allowed to login</span>
                            </div>
                            <div class="form-group">
                            ...
                            <!--<div class="checkbox">-->
                                <input type="hidden" class="i-checks" checked>
                                     <!--Remember login-->
                                <!--<p class="help-block small">(If you use a private computer)</p>
                            </div>-->
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <strong><span class="text-primary" style="color:#2ca02c !important; font-weight: bold; padding-right:0px !important">Tweende</span><span class="text-primary" style="color:#ff3300 !important; font-weight: bold;"></span></strong>
            - Powered By Probase <br/> {{date('Y')}} Copyright Probase
        </div>
    </div>
</div>
